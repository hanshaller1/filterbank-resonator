...
export class UI {
  constructor(store) {
    this.store = store;
    this.elements = {
      inputDevice: $('inputDevice'), outputDevice: $('outputDevice'), mute: $('mute'), inputPeak: $('inputPeak'), currentInput: $('currentInput'), currentOutput: $('currentOutput'),
      ...
      inputMeter: $('inputMeter'), outputMeter: $('outputMeter'), inputMeterValue: $('inputMeterValue'), outputMeterValue: $('outputMeterValue'), outputPeak: $('outputPeak'), compressorReductionValue: $('compressorReductionValue'),
  ...
  updateModulePowerLabels() {
    for (const id of ['gateEnabled', 'transientEnabled', 'driveEnabled', 'wavefolderEnabled', 'crusherEnabled', 'filterEnabled', 'eqEnabled', 'compressorEnabled', 'widthEnabled', 'freezeEnabled', 'clipperEnabled']) {
      ...
      if (status) status.textContent = control.checked ? 'ON' : 'OFF';
